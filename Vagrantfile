...
Vagrant.configure("2") do |config|
  ...
  config.vm.hostname = "yishuaili-starter"
  ...
  #
   config.vm.provision :chef_client do |chef|
     chef.chef_server_url = "https://api.opscode.com/organizations/nttdatalearn"
     chef.validation_client_name = "nttdatalearn-validator"
     chef.validation_key_path = ".chef/nttdatalearn-validator.pem"
   end
end
